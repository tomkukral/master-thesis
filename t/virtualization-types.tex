...
Virtualization is massively used even by czech companies. First group is used for example by \Name{Wedos} for their virtual server hosting and related services. Second group is uses by \Name{Seznam.cz} as they use \Ac{LXC} for web serves as well as for Hadoop cluster.
