...
\begin{description}
	\item[push] Memory pages are pushed from source to destination and pages changed during transfer are labeled as \Uv{dirty}. Dirty pages are transfered in next round. However, is is not possible to transfer all pages during this phase because some pages get dirtied faster than they can be transfered.
