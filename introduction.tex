...
%However, this legacy way of building data center bring some major disadvantages and it is was clear, that this approach is going to be changed during the time.
%
